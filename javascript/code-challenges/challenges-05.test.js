...
const toLastNames = people => {
  ...
  // Since index is optional, I removed it.
...
const addPurchases = (arr) => {
  return arr.reduce( (currentTotal, value) => currentTotal + value.purchasePrice, 0);
};
...
const countNumberOfElements = (arr) => {
  // return arr.reduce( (numberOfElements, value, index) => numberOfElements + 1, 0);
  // Since value and index are optional, I removed them.
  return arr.reduce( (numberOfElements) => numberOfElements + 1, 0);
};
...
const returnNames = (arr) => {
  return arr.reduce( (currentCharacters, character) => {
    currentCharacters.push(character.name);
