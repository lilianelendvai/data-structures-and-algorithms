...
const raisedToTheThird = (arr) => {
  return arr.map( (value, index) => Math.pow(value,3));
};
...
const addOne = (arr) => {
  return arr.map( (value, index) => value + 1);
};
...
const addQuestion = (arr) => {
  return arr.map( (value, index) => value + '?');
};
...
const mapTwoToThe = (arr) => {
  return arr.map( (value, index) => Math.pow(2,value));
};
...
const charCode = (arr) => {
  return arr.map( (value, index) => value.charCodeAt(0));
};
